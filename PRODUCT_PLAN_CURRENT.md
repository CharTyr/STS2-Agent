# STS2 AI Agent：当前状态页
> **当前发布：v0.16.1（2026-09-24，补丁）**。tag `v0.16.1` @ `a64e052`（dev 上的 Release 提交，PR #200 合并后 CI 通过）；GitHub Release 资产 779153 字节 / SHA256 `835E22E8…7551`；工坊物品 3796486050 于 11:54:48 更新（公开，`file_size` 1646567 = 本地字节和）。一处修复：单人模式/自动游玩中邀请队友**不再无声挂在 pending**，会记录 `Rejected` 并给出起因。实机修了证明，离线 866 + 423 全绿。见 [v0.16.1 发布记录](history/release-v0.16.1_2026-09-24.md)。上一版 v0.16.0 的记录见 [v0.16.0 发布记录](history/release-v0.16.0_2026-09-24.md)（思考流式/双层/截图布局全绿并实机复验，2026-09-24 补测双层与思考显示通过；AI 队友受限 Steam-off 环境记 BLOCKED）。**工坊简体中文列表仍待网页端手工粘贴**。
