...
| --- | --- | --- |
| Offline verification gates | `python scripts/check_verification_gates.py` | The nine gates above; `--only <gate>` narrows the run |
